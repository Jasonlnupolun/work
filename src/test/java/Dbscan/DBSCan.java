...
//		return Math.sqrt((point1.getX()-point2.getX())*(point1.getX()-point2.getX())+(point1.getY()-point2.getY())*(point1.getY()-point2.getY()));
		return (point1.getX()*point2.getX()+point1.getY()*point2.getY())/(Math.sqrt(point1.getX()*point1.getX()+point1.getY()*point1.getY())+Math.sqrt(point2.getX()*point1.getX()+point2.getY()*point2.getY()));
	}
	...
	public static void main(String[] args) throws IOException {
		...
		int MAXNUM = 150;//rds.getTextLines();
...
//        	File yfile= new File("C:/Users/Zengli/Desktop/数据挖掘-实验数据集/test3/cu"+i+"y.txt");
        	for(int j=0;j<pointNum;j++){
				...
				System.out.println(clusters.get(i-1).get(j).getX()+" x");
				System.out.println(clusters.get(i-1).get(j).getY()+" y");
...
//    		ReadDataset.append(yfile, Noise.get(i).getY()+" ");
			System.out.println( Noise.get(i).getX()+" x");
			System.out.println( Noise.get(i).getY()+" y");
        }
	}
}